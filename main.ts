...
function spawnDaniel () {
    Daniel = sprites.create(img`
        ...
        . . . . f f f . . . . . . . . . 
        `, SpriteKind.Player)
    Daniel.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    Daniel.setStayInScreen(true)
    controller.player2.moveSprite(Daniel, 200, 200)
...
info.player1.onLifeZero(function () {
    ...
    game.setDialogFrame(img`
        ...
        `)
    if (!(info.player2.hasLife())) {
        game.showLongText("Markus Wins!", DialogLayout.Bottom)
        game.gameOver(true)
    } else {
        game.showLongText("Oh no.. Markus is out..", DialogLayout.Bottom)
        sprites.destroy(Markus)
    }
})
info.player2.onLifeZero(function () {
    ...
    game.setDialogFrame(img`
        ...
        `)
    if (!(info.player1.hasLife())) {
        game.showLongText("Daniel Wins!", DialogLayout.Bottom)
        game.gameOver(true)
    } else {
        game.showLongText("Oh no.. Daniel is out..", DialogLayout.Bottom)
        sprites.destroy(Daniel)
    }
})
function spawnEnemy () {
    Monster = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Monster)
    Monster.setVelocity(-10, 10)
    Monster.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Monster, function (sprite, otherSprite) {
    ...
    sprites.destroyAllSpritesOfKind(SpriteKind.Monster, effects.rings, 500)
    pause(1000)
})
...
function spawnMarkus () {
    Markus = sprites.create(img`
        . . . . . f f f f . . . . . 
        . . . f f 5 5 5 5 f f . . . 
        . . f 5 5 5 5 5 5 5 5 f . . 
        ...
        . . . . f f b b f f . . . . 
        `, SpriteKind.Player)
    Markus.setPosition(randint(0, scene.screenWidth()), randint(0, scene.screenHeight()))
    Markus.setStayInScreen(true)
    controller.moveSprite(Markus, 200, 200)
    info.player1.setLife(3)
    info.player1.setScore(0)
}
let Monster: Sprite = null
let projectile: Sprite = null
let Markus: Sprite = null
let Daniel: Sprite = null
